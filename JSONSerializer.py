...
'''
original source http://web.archive.org/web/20120414135953/http://www.traddicts.org/webdevelopment/flexible-and-simple-json-serialization-for-django
I will maintain this library for my own personal use. nJoy.
datamafia.com
'''
...
class JSONSerializer():
    ...
    def handle_simple(self, simple):
        ...
        self.stream.write(unicode(json.dumps(simple)))
